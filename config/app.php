...
return [
    ...
    'EmailTransport' => [
		...
		'default' => [
			...
			'port' => 587,
			'username' => 'postmaster@rnftechnologies.com',
			'password' => '44f88f25e1443fd19a1bc2e3e9ed9cbd',
			'className' => 'Smtp',
			'ssl' => false
        ],
        'mailgun' => [
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => 'info@pheramor.com',
            'charset' => 'iso-8859-1',
            //'headerCharset' => 'utf-8',
        ],
        'mailgun' => [
			'transport' => 'mailgun',
			'mailgun_domain' => 'mg.mycom.com', //required
			'mailgun_api_key' => 'key-81dd3102263c53faaf8888888afd09b8',  //required
