...
<header><div class="col-xs-6"><i class="fa fa-bullseye" style="font-weight:bold;"></i> <strong>Active Goals</strong></div>
<div class="col-xs-6 text-right dashborad-date">Start Date: 20.03.2017</div><div class="clearfix"></div></header>
<article><div class="col-xs-8">Weight Gain</div>
<div class="col-xs-4 text-right">60 KG</div><div class="clearfix"></div></article>
<article><div class="col-xs-8">Weight Gain</div>
<div class="col-xs-4 text-right">60 KG</div><div class="clearfix"></div></article>
<article><div class="col-xs-8">Weight Gain</div>
<div class="col-xs-4 text-right">60 KG</div><div class="clearfix"></div></article>
    ...
    $(document).ready(function () {
        $('#calendars').fullCalendar({
            ...
            eventClick: function (event, jsEvent, view) {
                ...
                var ajaxurl = "<?php echo $base_url; ?>" + "/GymAjax/get" + title + "Details";
                //alert('title: ' + title + ' ------- date: ' + date + ' ---- ajaxUrl: ' + ajaxurl);
                var curr_data = {date: date,title:title};
                $.ajax({
                    url: ajaxurl,
                    data: curr_data,
                    type: "POST",
                    ...
                    success: function (result) {
                        if (result.status == 'success') {
                            ...
                            if(result.title == 'Workout'){
                                ...
                                initializeChart(result.data.zonesDuration);
...
<script>
    function initializeChart(zonesDuration){
