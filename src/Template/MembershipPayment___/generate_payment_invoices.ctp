...
$(".mem_valid_from").datepicker().on("changeDate",function(ev){
				...
				if(membership != "")
				{
					var curr_data = { date : date, membership:membership,user_id:user_id,licensee_id:licensee_id};
	...
	<div class="col-md-12">	
                 ...
                 <div class="portlet-title">
                     ...
                     <div class="top">
                         ...
                         <div class="btn-set pull-right">
                             <a href="<?php echo $this->Gym->createurl("GymMember","viewMember/".$members_ids); ?>" class="btn blue"><i class="fa fa-bars"></i> <?php echo __("View Member"); ?></a>
		...
		<input type="hidden" name="associated_licensee" id="associated_licensee" value="<?php echo $licensee;?>">
                <div class="form-body">
				...
				echo @$this->Form->select("user_id",$members,["default"=>$members_ids,"empty"=>__("Select Member"), "id"=>"user_id","class"=>"form-control validate[required]","disabled"]);
                                if($edit){
                                    echo $this->Form->input("",["type"=>"hidden","name"=>"user_id","id"=>"user_id","label"=>false,"class"=>"form-control","value"=>$data["member_id"]]);
				}
                                ?>
                    ...
                    <div class="form-group form-md-line-input" id="dprice" style="display:none;">
                        ...
                        <div class="col-sm-3"> $ <span id="paid_amount"></span></div>
		...
		<input type="hidden" value="<?php echo $this->request->base;?>/GymAjax/get_membership_end_date_price" id="mem_date_check_path">
