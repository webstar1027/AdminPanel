...
$this->Html->addCrumb('Membership Payment List');
?>
<div class="col-md-12">
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-dark">
                ...
                <span class="caption-subject bold uppercase"> <?php echo __("Membership Payment"); ?>
                </span>
                        ...
                        <div class="btn-group">
                            <?php
                             if ($session["role_name"] == "administrator" || $session["role_name"] == "manager" || $session["role_name"] == "licensee" || $session["role_name"] == "staff_member") {
                                ...
                                <a href="<?php echo $this->Gym->createurl("MembershipPayment", "generatePaymentInvoice"); ?>" class="btn sbold green"><?php echo __("Generate Payment Invoice"); ?> <i class="icon-doc"></i></a>
