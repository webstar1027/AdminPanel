...
$this->Html->addCrumb('Sports List');
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body">
          <?php
            ...
            ?>
             <input type="hidden" id="tbl_name" value="PheramorSports">
            ...
            <div class="form-body">
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control validate[required,ajax[isMasterTitleUnique]]" value="<?php echo ($edit) ? $races_data['name'] : ""; ?>" placeholder="Enter Sport Name"  name="name" id="name">
                        <div class="form-control-focus"> </div>
                        <span class="help-block">Enter Sport Name...</span>
                    </div>
             ...
             <div class="row">
                <div class="col-md-offset-2 col-md-6">
                    ...
                    <a href="<?php echo $this->Gym->createurl("PheramorSports","index"); ?>" class="btn default">Reset</a> 
                </div>
            </div>
            <p>&nbsp;</p>     
        </form>
...
<div class="col-md-12">
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-dark">
                <i class="icon-settings font-dark"></i>
                <span class="caption-subject bold uppercase"> <?php echo __("Sports List"); ?>
                </span>
                         ...
                         echo "<td>";
                            echo "<div class='btn-group'>
                                                ...
                                                <ul class='dropdown-menu pull-right' role='menu'>
                                                    ...
                                                    <li>
                                                        <a href='{$this->Pheramor->createurl("PheramorGames", "editGames")}/{$data->id}'>
                                                            <i class='icon-pencil'></i> Edit Games </a>
                                                    </li>
                                                    <li>
                                                        <a href='{$this->Pheramor->createurl("PheramorGames", "deleteGame")}/{$data->id}' onclick=\"return confirm('Are you sure,you want to delete this record?');\">
...
$(document).ready(function() {
        var dataTable = $('#employee-grid').DataTable( {
               ...
               // "columnDefs": [
                ...
                //  ],
                "ajax":{
                        url :"<?php echo $this->request->base . '/PheramorAjax/setSportsData'; ?>", // json datasource
