    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body">
          <?php
            ...
            ?>
              <input type="hidden" id="tbl_name" value="PheramorGames">
            ...
            <div class="form-body">
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control validate[required,ajax[isMasterTitleUnique]]" value="<?php echo ($edit) ? $races_data['name'] : ""; ?>" placeholder="Enter Game Name"  name="name" id="name">
                        <div class="form-control-focus"> </div>
                        <span class="help-block">Enter Game Name...</span>
                    </div>
             ...
             <div class="row">
                <div class="col-md-offset-2 col-md-6">
                    ...
                    <a href="<?php echo $this->Gym->createurl("PheramorGames","index"); ?>" class="btn default">Reset</a> 
                </div>
            </div>
            <p>&nbsp;</p>     
        </form>
...
<div class="col-md-12">
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-dark">
                <i class="icon-settings font-dark"></i>
                <span class="caption-subject bold uppercase"> <?php echo __("Games List"); ?>
                </span>
...
$(document).ready(function() {
        var dataTable = $('#employee-grid').DataTable( {
               ...
               // "columnDefs": [
                ...
                //  ],
                "ajax":{
                        url :"<?php echo $this->request->base . '/PheramorAjax/setGamesData'; ?>", // json datasource
