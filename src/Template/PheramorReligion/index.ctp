...
$this->Html->addCrumb('Religion List');
          ...
          <?php
            ...
            <div class="form-body">
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control validate[required]" value="<?php echo ($edit) ? $races_data['name'] : ""; ?>" placeholder="Enter Religion Name"  name="name">
                        <div class="form-control-focus"> </div>
                        <span class="help-block">Enter Religion Name...</span>
                    </div>
             ...
             <div class="row">
                <div class="col-md-offset-2 col-md-6">
                    ...
                    <a href="<?php echo $this->Gym->createurl("PheramorReligion","index"); ?>" class="btn default">Reset</a> 
                </div>
            </div>
            <p>&nbsp;</p>     
        </form>
...
<div class="col-md-12">
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-dark">
                <i class="icon-settings font-dark"></i>
                <span class="caption-subject bold uppercase"> <?php echo __("Religion List"); ?>
                </span>
                         ...
                         echo "<td>";
                            echo "<div class='btn-group'>
                                                ...
                                                <ul class='dropdown-menu pull-right' role='menu'>
                                                    ...
                                                    <li>
                                                        <a href='{$this->Pheramor->createurl("PheramorReligion", "editReligions")}/{$data->id}'>
                                                            <i class='icon-pencil'></i> Edit Religion </a>
                                                    </li>
                                                    <li>
                                                        <a href='{$this->Pheramor->createurl("PheramorReligion", "deleteReligion")}/{$data->id}' onclick=\"return confirm('Are you sure,you want to delete this record?');\">
                                                            <i class='icon-trash'></i> Delete Religion </a>
                                                    </li>
