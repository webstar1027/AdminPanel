      ...
      <td style="color:#000000;height:30px;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <th align="center" style="color:#ed4934; font-size:38px; width:20%">Product Name</th>
              <th align="center" style="color:#ed4934; font-size:38px; width:20%">Product Price</th>
            ...
            <tr>
             ...
             <td align="center" style="height:25px;font-size: 30px;"><?php $name=$this->Pheramor->get_subscription_names($data[0]["product_id"]); echo $name[0]['subscription_title']; ?></td>
             <td align="center" style="height:25px;font-size: 30px;"><?php echo $this->Pheramor->get_currency_symbol(); ?> <?php echo $data[0]["product_amount"]; ?></td>
            ...
            <tr>
                <td colspan="6" align="right" style="height:30px;font-size: 30px;"><strong>Product Amount :</strong> <?php echo $this->Gym->get_currency_symbol(); ?> <?php echo number_format((float)($data[0]["product_amount"]), 2, '.', ''); ?></td>
            </tr>
            <tr>
