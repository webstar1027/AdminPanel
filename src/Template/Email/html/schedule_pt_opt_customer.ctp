                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <p><strong style="color:#ed4934;">Congratulations! </strong> Your trainer <strong><?php echo $staff; ?></strong> has created <strong><?php echo $schedule_type; ?></strong> schedules for you. Please find below the details:</p>
