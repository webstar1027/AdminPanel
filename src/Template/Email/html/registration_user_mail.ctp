                  ...
                  <tbody>
                    <tr>
                      <td><p>Hi <strong><?php echo $name;?>,</strong></p>
                        ...
                        <p style=" text-align:center;"><a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'];?>" target="_blank" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">Portal Login</a></p>
                        ...
                        <p style=" text-align:center;"> <a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'];?>" target="_blank" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">Android Mobile App</a> <a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'];?>" target="_blank" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">iOS Mobile App</a> </p>
