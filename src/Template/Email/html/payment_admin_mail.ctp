                    ...
                    <tr>
                      <td style="background:#fff; text-align:left;"><p>Hi <strong><?php echo $adminName;?>,</strong></p>
                        <?php if(isset($transaction_id) && $transaction_id !=''){?>
                          <p><strong style="color:#ed4934;">Congratulations!</strong> A payment of <strong>$<?php echo $amount;?></strong> has been made for the customer <strong><?php echo $name;?>(<?php echo $email;?>)</strong>.</p>
                        <?php }else{?>
                            <p>A payment of <strong>$<?php echo $amount;?></strong> has failed for the customer <strong><?php echo $name;?>(<?php echo $email;?>)</strong>.</p>
                        <?php }?>
