                  ...
                  <tbody>
                    <tr>
                      <td style="background:#fff; text-align:left;"><p>Hi <strong><?php echo $name;?>,</strong></p>
                        ...
                        <p style="text-align:center;"><a href="<?php echo $_SERVER['HTTP_HOST'];?>/<?php echo $link;?>" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">Reset Your Password</a></p>
                        <p>If you're having trouble clicking the Reset Your Password button, copy and paste the below link into your web browser.</p>
                        <p><a href="<?php echo $_SERVER['HTTP_HOST'];?>/<?php echo $link;?>" style="color: #444;"><?php echo $_SERVER['HTTP_HOST'];?>/<?php echo $link;?></a></p>
                        ...
                        <p><strong>Thanks,</strong><br/>
                          GoTRIBE Team.</p>
                        <a href="google.com" style="color: #444;">click here</a>
                      </td>
                    </tr>
                  </tbody>
                </table></td>
