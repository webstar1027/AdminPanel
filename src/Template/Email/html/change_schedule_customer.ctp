...
<html>
    <head>
        ...
        <title>GoTRIBE::Change Schedule</title>
    </head>
    <body>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <p> Your Trainer <strong><?php echo $staff; ?></strong> has changed your <strong><?php echo $schedule_type; ?></strong> schedule for date <strong><?php echo date($this->Gym->getSettings('date_format'), strtotime($date));?></strong>. Please find below details.</p>
