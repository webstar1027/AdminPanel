          ...
          <tbody>
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><p>Hi <strong><?php echo $name;?>,</strong></p>
                        <p><strong style="color:#ed4934;">Congratulations!</strong> You are registered with <strong>GoTRIBE</strong>.</p>
                        <p>Click below button to login into <strong>GoTribe</strong> portal.</p>
                        <p style=" text-align:center;"><a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'];?>/digCycle/login" target="_blank" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">Portal Login</a></p>
                        <p>If you're having trouble clicking the login button, copy and paste the following link into your web browser.</p>
                        <p><a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'];?>" target="_blank" style="color: #444;"><?php echo $_SERVER['HTTP_HOST'];?></a></p>
                        <p>Please find below the download link for Android and iOS Mobile app.</p>
                        <p style=" text-align:center;"> <a href="<?php echo 'https://play.google.com/store/apps/details?id=com.gotribe.mobile&hl=en';?>" target="_blank" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">Android Mobile App</a> <a href="<?php echo 'https://itunes.apple.com/us/app/gotribe/id1050576546?mt=8';?>" target="_blank" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">iOS Mobile App</a> </p>
