          ...
          <tbody>
            ...
            <tr>
              <td><table  width="600" cellpadding="0" cellspacing="0" align="left">
                  <tbody>
                    <tr>
                      <td style="background:#fff; text-align:left;"><p>Hi <strong>Super Admin,</strong></p>
                        <?php if($method=='fail'){?>
                          <p><strong style="color:#ed4934;">Sorry!</strong>An amount of  <strong>$<?php echo $amount;?></strong> has been failed from<strong><?php echo $name;?>(<?php echo $username;?>)</strong> account.</p>
                           
                        <?php }else{?>
                        <p><strong style="color:#ed4934;">Congratulations!</strong>An amount of  <strong>$<?php echo $amount;?></strong> has been charged from<strong><?php echo $name;?>(<?php echo $username;?>)</strong> and transferred to your account.</p>
                        <?php } ?>
                        <p>&nbsp;</p>
