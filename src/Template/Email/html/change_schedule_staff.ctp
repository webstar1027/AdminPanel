                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <p>You have been successfully changed your <strong><?php echo $schedule_type; ?></strong> schedule for date <strong><?php echo date($this->Gym->getSettings('date_format'), strtotime($date));?></strong>. Please find the below info.</p>
