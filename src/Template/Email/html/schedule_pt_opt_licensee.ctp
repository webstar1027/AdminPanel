                                ...
                                <tr>
                                    <td style="width: 100%;text-align: center;background: #E9E9E9;border-top: 6px solid #1e4491;">
                                        <table cellpadding="0" cellspacing="0" style="width:80%;text-align:center;padding: 25px 0;color: #fff;margin:auto;" align="center">
                                            <tbody><tr>
                                                    <td>
                                                        <a href="" target="_blank"><img style="display: inline-block; width: 200px;" src="<?php echo 'http://'.$_SERVER['HTTP_HOST']; ?>/img/Thumbnail-img2.png" alt="GoTribe"></a>
                                                    </td>
                                                </tr>
                                            </tbody></table>
                                    </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" align="left">
                                            <tbody>
                                                <tr style="background:#fff; text-align:left;">
                                                    ...
                                                    <p><strong>Congratulations!</strong> Your trainer (<?php echo $staff; ?>) have been successfully scheduled <?php echo $schedule_type; ?> for a <?php echo $customer; ?>. Please have a look at following schedules.</p>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a target="_blank" href="#" style="width: 30px; text-decoration:none; padding: 0px 5px;">
                                                                            <img alt="Facebook" src="<?php echo 'http://'.$_SERVER['HTTP_HOST']; ?>/webroot/img/email/footer_facebook.png" style="margin:5px 0">
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <a target="_blank" href="#" style="width: 30px; text-decoration:none; padding: 0px 5px;">
                                                                            <img alt="LinkedIn" src="<?php echo 'http://'.$_SERVER['HTTP_HOST']; ?>/webroot/img/email/footer_linkedin.png" style="margin:5px 0;">
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <a target="_blank" href="#" style="width: 30px; text-decoration:none; padding: 0px 5px;">
                                                                            <img alt="Twitter" src="<?php echo 'http://'.$_SERVER['HTTP_HOST']; ?>/webroot/img/email/footer_twitter.png" style="margin:5px 0;">
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <a target="_blank" href="#" style="width: 30px; text-decoration:none; padding: 0px 5px;">
                                                                            <img alt="google+" src="<?php echo 'http://'.$_SERVER['HTTP_HOST']; ?>/webroot/img/email/google.png" style="margin:5px 0">
                                                                        </a>    
                                                                    </td>
                                                                    <td>
                                                                        <a target="_blank" href="#" style="width: 30px; text-decoration:none; padding: 0px 5px;">
                                                                            <img alt="pinterest" src="<?php echo 'http://'.$_SERVER['HTTP_HOST']; ?>/webroot/img/email/pinterest.png" style="margin:5px 0">
                                                                        </a>
                                                                    </td> 
                                                                </tr>
                                                            </tbody>
