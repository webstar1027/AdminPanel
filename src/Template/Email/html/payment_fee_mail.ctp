                  ...
                  <tbody>
                    <tr>
                      <td style="background:#fff; text-align:left;"><p>Hi <strong><?php echo $name;?>,</strong></p>
                         ...
                         <?php if($method=='fail'){?> 
                           <p><strong style="color:#ed4934;">Sorry!</strong> An amount of  <strong>$<?php echo $amount;?></strong> has been failed to GoTRIBE's account.</p>
                         <?php } else { ?>
                         <p><strong style="color:#ed4934;">Congratulations!</strong> An amount of  <strong>$<?php echo $amount;?></strong> has been transferred to GoTRIBE's account.</p>
                         <?php } ?>
