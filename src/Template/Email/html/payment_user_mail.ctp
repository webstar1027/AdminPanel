                    ...
                    <tr>
                      <td style="background:#fff; text-align:left;"><p>Hi <strong><?php echo $name;?>,</strong></p>
                        <?php if(isset($transaction_id) && $transaction_id !=''){?>
                          <p><strong style="color:#ed4934;">Congratulations!</strong> Your payment of <strong>$<?php echo $amount;?></strong> has been successfully made with <strong>GoTRIBE</strong>. Please find your payment info below.</p>
                        <?php }else{?>
                            <p>Your payment of <strong>$<?php echo $amount;?></strong> has failed. Please find your payment info below.</p>
                        <?php }?>
