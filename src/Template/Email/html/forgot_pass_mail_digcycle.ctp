                  ...
                  <tbody>
                    <tr>
                      <td style="background:#fff; text-align:left;"><p>Hi <strong><?php echo $name;?>,</strong></p>
                        ...
                        <p style="text-align:center;"><a href="https://<?php echo $_SERVER['HTTP_HOST'];?>/DigCycle/reset_password_token/<?php echo $link;?>" target="_blank" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">Reset Your Password</a></p>
                        <p>If you're having trouble clicking the Reset Your Password button, copy and paste the below link into your web browser.</p>
                        <p><a href="https://<?php echo $_SERVER['HTTP_HOST'];?>/DigCycle/reset_password_token/<?php echo $link;?>" target="_blank" style="color: #444;">https://<?php echo $_SERVER['HTTP_HOST'];?>/DigCycle/reset_password_token/<?php echo $link;?></a></p>
