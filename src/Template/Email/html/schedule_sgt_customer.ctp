                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <p><strong style="color:#ed4934;">Congratulations! </strong> You have successfully enrolled in `Small Group Training` schedule. Please find the schedule info below.</p>
