                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <p><strong style="color:#ed4934;">Congratulations! </strong> You have successfully created a <strong><?php echo $schedule_type; ?></strong> schedules for<strong><?php echo $customer; ?></strong>. Please find below the details:</p>
