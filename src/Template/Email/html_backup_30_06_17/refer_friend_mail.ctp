                  ...
                  <tbody>
                    <tr>
                      <td style="background:#fff; text-align:left;"><p> <strong>
                        ...
                        <p>Your friend <strong><?php echo $name;?></strong> < <?php echo $email;?> > referred you to join <strong>GoTRIBE</strong>.  <strong>GoTRIBE</strong> believes in `Results Through Relationship`, and offers 3 ways to train - `Personal Training`, `Small Group Training` & `Online Personal Training`. </p>
                        <p style=" text-align:center;"><a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/member-registration" target="_blank" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">Check Us Out</a></p>
