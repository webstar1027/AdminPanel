                  ...
                  <tbody>
                    <tr>
                      <td  style="background:#fff; text-align:left;"><p>Hi <strong><?php echo $name;?>,</strong></p>
                        <p><strong style="color:#ed4934;">Congratulations! </strong>You have successfully changed your password that you recently requested for your <strong>GoTRIBE</strong> account.</p>
                        <p>&nbsp;</p>
