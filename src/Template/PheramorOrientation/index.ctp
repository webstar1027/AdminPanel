...
$this->Html->addCrumb('Sexual Orientation List');
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body">
          <?php
            ...
            ?>
             <input type="hidden" id="tbl_name" value="PheramorOrientation">
            ...
            <div class="form-body">
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control validate[required,ajax[isMasterTitleUnique]]" value="<?php echo ($edit) ? $races_data['name'] : ""; ?>" placeholder="Enter Sexual Orientation"  name="name" id="name">
                        <div class="form-control-focus"> </div>
                        <span class="help-block">Enter Sexual Orientation...</span>
                    </div>
             ...
             <div class="row">
                <div class="col-md-offset-2 col-md-6">
                    ...
                    <a href="<?php echo $this->Gym->createurl("PheramorOrientation","index"); ?>" class="btn default">Reset</a> 
                </div>
            </div>
            <p>&nbsp;</p>     
        </form>
...
<div class="col-md-12">
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-dark">
                <i class="icon-settings font-dark"></i>
                <span class="caption-subject bold uppercase"> <?php echo __("Sexual Orientation List"); ?>
                </span>
            ...
            <table class="mydataTable table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                ...
                <tbody>
                   <?php
                    ...
                    $k = 1;
                    foreach ($orientation_data as $data) {
                       if ($data->status== 1) {
                         ...
                         echo "<td>";
                            echo "<div class='btn-group'>
                                                ...
                                                <ul class='dropdown-menu pull-right' role='menu'>
                                                    ...
                                                    <li>
                                                        <a href='{$this->Pheramor->createurl("PheramorOrientation", "editOrientations")}/{$data->id}'>
                                                            <i class='icon-pencil'></i> Edit Sexual Orientation </a>
                                                    </li>
                                                    <li>
                                                        <a href='{$this->Pheramor->createurl("PheramorOrientation", "deleteOrientation")}/{$data->id}' onclick=\"return confirm('Are you sure,you want to delete this record?');\">
                                                            <i class='icon-trash'></i> Delete Sexual Orientation </a>
                                                    </li>
