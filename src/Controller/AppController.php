...
//	public $helpers = ['AkkaCKEditor.CKEditor'];
    ...
    public function isAuthorizedCustom($user) {
        ...
        $actions_list = $this->PHMFunction->getActionsByRoles($user["role_id"], $controller);
    ...
    public function beforeFilter(Event $event) {
         ...
         $currentAction = $this->request->params['controller']; 
          if($this->request->controller != 'PheramorEvents'){
...
//		}
        ...
        /*
        if($this->request->controller == 'PulseOfTheTribe'){
            if ($this->request->is('ssl')) {
                $schema = 'http://';
                $this->redirect($schema . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']);
            }
