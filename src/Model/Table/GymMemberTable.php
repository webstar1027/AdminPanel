...
Class GymMemberTable extends Table{
	...
	public function initialize(array $config)
	{
		...
		$this->belongsTo("StaffMembers",["foreignKey"=>"assign_staff_mem"]);
                ...
                $this->belongsTo("GymMemberLicensee");
		...
		$this->BelongsTo("GymRoles",["foreignKey"=>"role"]); //for staffmember
                ...
                $this->BelongsTo("TrialMember"); 
		$this->hasOne("UnsubscribedMember",["foreignKey"=>"mem_id"]); 
                $this->BelongsTo("ClassScheduleList"); 
                $this->BelongsTo("RefundPaymentHistory"); 
		$this->BelongsTo("Specialization",["foreignKey"=>"s_specialization","propertyName"=>"specialization"]); 
                $this->belongsTo("ProductPayment");
             //for staffmember
		/* 
